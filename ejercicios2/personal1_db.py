...
conn.execute(
    ...
    VALUES ('Juan','Gonzales','Perez','2023-05-15')
    """
)
conn.execute(
    """
    INSERT INTO EMPLEADOS (nombre, apellido_paterno, apellido_materno, fecha_contratacion) 
    VALUES ('Maria','Lopez','Martinez','2020-04-10')
    """
)
...
conn.execute(
    ...
    VALUES (3000,'2024-04-01','2023-05-15','2023-05-15')
    """
)
conn.execute(
    """
    INSERT INTO SALARIOS(salario,fecha_inicio,fecha_fin,fecha_creacion) 
    VALUES (3500,'2023-07-01','2024-04-30','2023-06-20')
    """
)
